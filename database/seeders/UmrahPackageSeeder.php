...
class UmrahPackageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        UmrahPackage::create([
            ...
            'departure_date' => Carbon::now()->addMonth(), // Tambah satu bulan dari sekarang
            'duration' => 12,
            'price' => 120000,
        ...
        UmrahPackage::create([
            ...
            'departure_date' => Carbon::now()->addMonths(2), // Tambah dua bulan dari sekarang
            'duration' => 10,
            'price' => 110000,
        ...
        UmrahPackage::create([
            ...
            'departure_date' => Carbon::now()->addMonths(3), // Tambah tiga bulan dari sekarang
            'duration' => 15,
            'price' => 150000,
            'facility' => 'Fasilitas Lorem ipsum dolor sit amet',
            'destination' => 'Makkah',
        ...
        UmrahPackage::create([
            ...
            'departure_date' => Carbon::now()->addMonths(4), // Tambah empat bulan dari sekarang
            'duration' => 12,
            'price' => 130000,
            'facility' => 'Fasilitas Lorem ipsum dolor sit amet',
