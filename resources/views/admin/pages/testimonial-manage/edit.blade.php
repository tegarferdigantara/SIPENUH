            ...
            <div class="mx-auto max-w-270">
                ...
                <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <h2 class="text-title-md2 font-bold text-black dark:text-white">
                        Kelola Testimoni - Edit Testimoni
                    </h2>
                    <nav>
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form action="{{ route('admin.testimonial.update', ['testimonialId' => $testimonial->id]) }}"
                        method="POST">
                        @method('PUT')
                        @csrf
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                ...
                                <textarea type="text" name="review" rows="10" required
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"> {{ old('review', $testimonial->review) }}</textarea>
                                @error('review')
                            ...
                            <div class="mb-4.5">
                                ...
                                <input type="number" name="rating" value="{{ old('rating', $testimonial->rating) }}"
                                    min="1" max="5"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                @error('rating')
                                    <p class="text-meta-1 text-sm text-black font-medium mt-2">{{ $message }}</p>
