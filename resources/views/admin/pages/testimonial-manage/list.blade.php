        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <h2 class="text-title-md2 font-bold text-black dark:text-white">
                    Kelola Testimoni - Daftar Testimoni
                </h2>
            ...
            <div class="flex flex-col gap-10">
                ...
                <div
                    ...
                    <div class="max-w-full overflow-x-auto">
                        <div class="flex justify-between items-center mb-4">
                            <div class="flex gap-4">
                                <a href="{{ route('admin.testimonial.create') }}"
                                    ...
                                    <span>
                                        <svg fill="none" class="fill-current" width="20" height="20"
                                            version="1.1" id="lni_lni-circle-plus" xmlns="http://www.w3.org/2000/svg"
                        ...
                        {{-- @dd($testimonials) --}}
                        <table class="w-full table-auto" id="testimonialTable">
                            <thead>
                            ...
                            <tbody>
                                @foreach ($testimonials as $testimonial)
                                    <tr>
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white">{{ $testimonial->customer->full_name }}
                                            </p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white">
                                                {{ $testimonial->customer->umrahPackage->name }}
                                            </p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white">
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                <a class="hover:text-primary"
                                                    href="{{ route('admin.testimonial.edit', ['testimonialId' => $testimonial->id]) }}"
                                                ...
                                                <form id="delete-form-{{ $testimonial->id }}"
                                                    action="{{ route('admin.testimonial.destroy', ['testimonialId' => $testimonial->id]) }}"
                                                    method="POST" style="display: none;">
                                                    @csrf
                                                    @method('Delete')
                                                </form>
                                                <button class="hover:text-primary" title="Hapus Testimoni"
                                                    onclick="confirmDelete('delete-form-{{ $testimonial->id }}')">
...
@push('scripts')
    <script>
        new DataTable('#testimonialTable')
    </script>
