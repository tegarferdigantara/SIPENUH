                        ...
                        <div
                            ...
                            <div class="p-7">
                                ...
                                <div class="flex justify-end gap-4.5">
                                    ...
                                    <form id="delete-package-form-{{ $package->id }}" action="#" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('Delete')
                                    </form>
                                    @if ($package->customers()->count() == 0 && $package->itinerary()->count() == 0)
                                        <button
                                            ...
                                            onclick="confirmDelete('delete-package-form-{{ $package->id }}')">
                                            <span>
                                        ...
                                        <li
                                            ...
                                            <div class="flex items-center space-x-2 p-1">
                                                ...
                                                <form
                                                    ...
                                                    id="delete-itinerary-form-{{ $itinerary->id }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                <button class="hover:text-primary" title="Delete Itinerary"
                                                    onclick="confirmDelete('delete-itinerary-form-{{ $itinerary->id }}')">
                                                    <svg class="fill-current" width="18" height="18"
                                                        viewBox="0 0 18 18" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
