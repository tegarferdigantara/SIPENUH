                ...
                <div class="grid grid-cols-5 gap-8">
                    <div class="col-span-5 xl:col-span-3">
                        <div
                            ...
                            <div class="p-7">
                                <form
                                    action="{{ route('admin.customer.detail.by.package.edit.post', ['packageId' => $customer->umrah_package_id, 'customerId' => $customer->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-5.5">
                    ...
                    <div class="col-span-5 xl:col-span-2">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <form
                                    action="{{ route('admin.customerDocument.rotate.photo', ['customerId' => $customer->id, 'type' => 'family_card_number']) }}"
                                    method="post">
                                    @csrf
