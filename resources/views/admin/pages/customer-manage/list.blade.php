                    ...
                    <div class="max-w-full overflow-x-auto">
                        <div class="flex justify-between items-center m-4">
                            <div class="flex gap-4">
                                @if (Route::currentRouteName() === 'admin.customer.list.by.package' && $customers->count() > 0)
                                    <a href="{{ route('download.export.all.data', ['umrahPackageId' => $umrahPackage->id]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                ...
                                                <form id="delete-customer-form-{{ $customer->registration_number }}"
                                                    action="{{ route('admin.customer.destroy', ['registrationNumber' => $customer->registration_number]) }}"
                                                    method="POST" style="display: none;">
                                                    @csrf
                                                    @method('Delete')
                                                </form>
                                                <button class="hover:text-primary" title="Delete Data Jemaah"
                                                    onclick="confirmDelete('customer-{{ $customer->registration_number }}')">
                                                    <svg class="fill-current" width="18" height="18"
                                                        viewBox="0 0 18 18" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
