                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white">
                                                {{ mb_convert_case($user->getRoleNames()->implode(' ,'), MB_CASE_TITLE, 'UTF-8') }}
                                            </p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white">
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <p class="text-black dark:text-white">{{ $user->whatsapp_number }}</p>
                                        </td>
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                            <div class="flex items-center space-x-3.5">
                                                <a class="hover:text-primary"
                                                    href="{{ route('admin.users.edit', ['userId' => $user->id]) }}"
                                                    title="Edit Akun">
                                                ...
                                                @if ($user->getRoleNames()->implode(' ,') != 'admin')
                                                    ...
                                                    <button class="hover:text-primary" title="Delete Akun"
                                                        onclick="confirmDelete('delete-user-form-{{ $user->id }}')">
