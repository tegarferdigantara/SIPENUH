        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            @role('manager')
                <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                    <!-- ====== Chart One Start -->
                    <div
                        class="col-span-12 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-4 py-6 md:px-6 xl:px-7.5 overflow-x-auto">
                        <div class="pb-6">
                    ...
                    <div
                        class="col-span-12 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-4 py-6 md:px-6 xl:px-7.5 overflow-x-auto">
                        <div class="pb-6">
                            <h4 class="text-xl font-bold text-black dark:text-white">Jemaah Yang Tidak Memiliki Paspor</h4>
                        </div>
                        <table class="w-full table-auto" id="customerWithoutPassportTable">
                            <thead>
                                <tr class="bg-gray-2 text-left dark:bg-meta-4">
                                    <th class="min-w-[220px] px-4 py-4 font-medium text-black dark:text-white xl:pl-11">
                                        Nama
                            ...
                            <tbody>
                                @isset($customers)
                                    @foreach ($customersWithoutPassport as $customer)
                                        <tr>
                                            <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                                <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                                    <div class="h-10.5 w-10.5 rounded-md">
...
@push('scripts')
    <script>
        ...
        new DataTable('#customerWithoutPassportTable')
    </script>
