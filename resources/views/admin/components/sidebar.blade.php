            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="#"
                            @click.prevent="selected = (selected === 'Daftar Jemaah Umrah' ? '':'Daftar Jemaah Umrah')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'Daftar Jemaah Umrah') || (
                    ...
                    c0.5,1.1,1.9,1.6,3,1.1l4.2-2l4.5,2c0.3,0.1,0.6,0.2,0.9,0.2C38,42.2,38.8,41.7,39.2,40.9z" />
                        ...
                        <div class="translate transform overflow-hidden"
                            :class="(selected === 'Daftar Jemaah Umrah') ? 'block' : 'hidden'">
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="form-elements.html"
                                        :class="page === 'formElements' && '!text-white'">Umrah Januari
                                        <span
                                            class="absolute right-4 block rounded bg-success px-2 py-1 text-xs font-medium text-white">Aktif</span></a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="#"
                            @click.prevent="selected = (selected === 'Daftar Paket Umrah' ? '':'Daftar Paket Umrah')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'Daftar Paket Umrah') || (
                                    page === 'formElements' || page === 'formLayout')
                            }">
                            <svg class="fill-current" width="18" height="18" fill="none" version="1.1"
                                id="lni_lni-package" xmlns="http://www.w3.org/2000/svg"
              ...
              h51.5v28.6C57.8,55.2,56.3,56.6,54.5,56.6z" />
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="translate transform overflow-hidden"
                            :class="(selected === 'Daftar Paket Umrah') ? 'block' : 'hidden'">
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="form-elements.html"
                                        :class="page === 'formElements' && '!text-white'">Form Elements
                                        <span
