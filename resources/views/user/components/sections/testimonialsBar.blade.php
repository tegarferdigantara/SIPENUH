            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[485px] text-center">
                    ...
                    <h2
                        ...
                        Apa Kata Jemaah Kami
                    </h2>
                    <p class="text-base text-body-color dark:text-dark-6">
                        Dengarkan langsung dari jemaah yang telah mempercayakan perjalanan umrah mereka kepada Assyubban
                        Tour. Pengalaman mereka adalah bukti komitmen kami dalam memberikan layanan
                        terbaik.
                    </p>
                </div>
            </div>
