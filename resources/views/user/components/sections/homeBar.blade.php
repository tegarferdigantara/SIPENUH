            ...
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    <h1
                        ...
                        Wujudkan Perjalanan Suci Anda Bersama Assyubban Tour
                    </h1>
                    <p class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                        Layanan Umrah Berkualitas dengan Bimbingan Ahli, Akomodasi Nyaman, dan Pelayanan Prima untuk
                        ...
                        <li>
                            <a href="#contact"
                                ...
                                <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        d="M21.5 5.25L12 13.75L2.5 5.25M2.5 5.25C2.5 4.007 3.507 3 4.75 3H19.25C20.493 3 21.5 4.007 21.5 5.25ZM2.5 5.25V18.25C2.5 19.493 3.507 20.5 4.75 20.5H19.25C20.493 20.5 21.5 19.493 21.5 18.25V5.25" />
                                </svg>
                                Konsultasi Gratis
                            </a>
                        </li>
                    ...
                    <div>
                        <p class="mb-4 text-center text-base font-medium text-white">
                            Dilengkapi fasilitas dan layanan terbaik
                        </p>
                        <div class="wow fadeInUp flex items-center justify-center gap-4 text-center"
                            data-wow-delay=".3s">
                            <a href="#" class="text-white/60 duration-300 ease-in-out hover:text-white"
                                title="Berpengalaman">
                                <svg class="fill-current" width="30" height="30" viewBox="0 0 30 30"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M15 2.5C8.1 2.5 2.5 8.1 2.5 15C2.5 21.9 8.1 27.5 15 27.5C21.9 27.5 27.5 21.9 27.5 15C27.5 8.1 21.9 2.5 15 2.5ZM15 25C9.475 25 5 20.525 5 15C5 9.475 9.475 5 15 5C20.525 5 25 9.475 25 15C25 20.525 20.525 25 15 25Z" />
                                    <path
                                        d="M15.875 9.375H13.75V16.25L19.6875 19.8125L20.625 18.3125L15.875 15.3125V9.375Z" />
                                </svg>
                            </a>
                            <a href="#" class="text-white/60 duration-300 ease-in-out hover:text-white"
                                ...
                                <svg class="fill-current" width="30" height="30" viewBox="0 0 30 30"
                                    ...
                                    <path
                                        d="M15 17.5C9.6125 17.5 5 22.1125 5 27.5H25C25 22.1125 20.3875 17.5 15 17.5Z" />
                                </svg>
                            </a>
                            <a href="#" class="text-white/60 duration-300 ease-in-out hover:text-white"
                                ...
                                <svg class="fill-current" width="30" height="30" viewBox="0 0 30 30"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M25 10H5V7.5H25V10ZM26.25 2.5H3.75C3.05964 2.5 2.5 3.05964 2.5 3.75V26.25C2.5 26.9404 3.05964 27.5 3.75 27.5H26.25C26.9404 27.5 27.5 26.9404 27.5 26.25V3.75C27.5 3.05964 26.9404 2.5 26.25 2.5ZM25 25H5V12.5H25V25Z" />
                                </svg>
                            </a>
                            <a href="#" class="text-white/60 duration-300 ease-in-out hover:text-white"
                                title="Izin Resmi">
                                <svg class="fill-current" width="30" height="30" viewBox="0 0 30 30"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M15 2.5L3.75 7.5V13.75C3.75 19.775 8.4625 25.3875 15 26.875C21.5375 25.3875 26.25 19.775 26.25 13.75V7.5L15 2.5ZM23.75 13.75C23.75 18.5125 20.0875 22.85 15 24.2375C9.9125 22.85 6.25 18.5125 6.25 13.75V9.1875L15 5.3125L23.75 9.1875V13.75ZM9.9625 14.5125L8.125 16.35L12.5 20.725L21.875 11.35L20.0375 9.5125L12.5 17.05L9.9625 14.5125Z" />
                                </svg>
                            </a>
                        </div>
                    </div>
            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                        Kami menyediakan layanan umrah terbaik dengan berbagai keunggulan untuk
                        memastikan perjalanan ibadah Anda nyaman dan bermakna.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
                    <div
                        ...
                        <svg fill="white" width="37" height="37" id="Layer_1" data-name="Layer 1"
                    ...
                    <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                        Bimbingan Ibadah Professional
                    </h4>
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        Tim pembimbing kami yang berpengalaman akan memandu Anda dalam setiap tahapan ibadah umrah.
                    </p>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
                    <div
                        ...
                        <span
                            class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                        <svg fill="white" width="36" height="36" version="1.1" id="lni_lni-skipping-rope"
                    ...
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        Kami menyediakan paket umrah yang dapat disesuaikan dengan kebutuhan dan budget Anda.
                    </p>
                    {{-- <a href="javascript:void(0)"
                        class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                        Learn More
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
                    <div
                        ...
                        <span
                            class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                        <svg fill="white" width="37" height="37" version="1.1" id="lni_lni-travel"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                            y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;"
                            xml:space="preserve">
                            <g>
                    ...
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        Kami bekerja sama dengan hotel-hotel terbaik di Mekkah dan Madinah untuk kenyamanan Anda.
                    </p>
                    {{-- <a href="javascript:void(0)"
                        class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                        Learn More
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
                    <div
                        ...
                        <span
                            class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                        <svg fill="white" width="52" height="52" version="1.1"
                            id="lni_lni-money-protection" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        Kami menawarkan harga umrah yang terjangkau tanpa mengurangi kualitas layanan.
                    </p>
                    {{-- <a href="javascript:void(0)"
                        class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                        Learn More
