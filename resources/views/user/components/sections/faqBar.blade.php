            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[520px] text-center">
                    ...
                    <h2
                        ...
                        Ada Pertanyaan Seputar Umrah?
                    </h2>
                    <p class="mx-auto max-w-[485px] text-base text-body-color dark:text-dark-6">
                        Temukan jawaban untuk pertanyaan umum seputar perjalanan umrah Anda bersama Assyubban Tour. Kami
                        siap membantu mewujudkan ibadah umrah yang nyaman dan bermakna.
                    </p>
                </div>
            </div>
        </div>
        <div class="-mx-4 flex flex-wrap">
            @foreach ($faqs->chunk(2) as $faqGroup)
